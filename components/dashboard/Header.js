export default function Header() {
    return (
        <header className="sticky top-0 z-50 bg-white/50 dark:bg-gray-900/20 backdrop-blur-md border-b border-gray-400/60 dark:border-gray-800/60 px-6 py-4 shadow-sm">
